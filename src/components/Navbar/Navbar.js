    ...
    return (
        <div className="w-full">
            <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border-x-gray-100 md:flex-row md:space-x-8">
                ...
                <button type="button" onClick={() => handleViewCart} className="inline-flex relative items-center p-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
